...
function assets(){
    ...
    wp_register_style('montserrat', 'https://fonts.googleapis.com/css2?family=Montserrat:wght@400&display=swap', '', '1.0', 'all');
...
//Aqui es donde vamos a cargar nuestros widgets
function sidebar(){
    register_sidebar(
        array(
            'name' => 'Pie de página',
